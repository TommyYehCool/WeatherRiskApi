...
public class Test_MongoDB_ParkingLotAvailable {
	
	@Autowired
	private ParkingLotAvailableRepository parkingLotAvailableRepo;

	@Test
	public void test_1_findParkingLotAvailable() {
		ParkingLotAvailable parkingLotAvailable = parkingLotAvailableRepo.findById("056");
